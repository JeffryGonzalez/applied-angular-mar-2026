  ...
  template: `
    <app-ui-page title="Timer Settings">
      <div class="flex flex-col gap-6 max-w-md">
        ...
        <div class="form-control">
          <label class="label">
            <span class="label-text font-semibold">Rakib Focus Duration</span>
            <span class="label-text-alt text-error font-bold">{{ store.rakibWorkMinutes() }} min</span>
          </label>
          <input
            type="range"
            class="range range-error"
            ...
            max="60"
            step="1"
            [ngModel]="store.rakibWorkMinutes()"
            (ngModelChange)="store.setRakibWorkMinutes($event)"
          />
          <div class="flex justify-between text-xs text-base-content/50 px-1 mt-1">
            <span>1 min</span>
            <span>30 min</span>
        ...
        <!-- Rakib break duration -->
        <div class="form-control">
          <label class="label">
            <span class="label-text font-semibold">Rakib Break Duration</span>
            <span class="label-text-alt text-info font-bold">{{ store.rakibBreakMinutes() }} min</span>
          </label>
          <input
            type="range"
            class="range range-info"
            ...
            max="30"
            step="1"
            [ngModel]="store.rakibBreakMinutes()"
            (ngModelChange)="store.setRakibBreakMinutes($event)"
          />
          <div class="flex justify-between text-xs text-base-content/50 px-1 mt-1">
            <span>1 min</span>
            <span>15 min</span>
